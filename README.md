...
Antes que nada, habrá que tener instalado la herramienta **Visual Studio Code** y **Node.js** (https://nodejs.org/es/download/) en el ordenador para proceder a la instalación del proyecto,
